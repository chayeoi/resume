module.exports = {
  siteMetadata: {
    ...
    about: {
      ...
      content: `
        3년차 개발자입니다.
        <strong>코드 리뷰 등을 통한 기술적 토론</strong>을 즐기며, 평소에 생각을 글로 정리하고 이것저것 <a href="https://www.notion.so/chayeoi/b20086d9e4b1469097ff51b26d822c59?v=d70b436ba26b4dd0abe0f02a72d6f8b6" target="_blank">꼼꼼히 기록</a>하는 습관이 있습니다. 이외에도 개발 커뮤니티 활동에 적극적으로 참여하고 <a href="https://www.notion.so/chayeoi/7450220672254e9398185811949bdfa0?v=7c381efa784840368e31f45e5658cd66" target="_blank">새로운 아이디어가 생각나면 팀을 꾸려 토이 프로젝트를 진행</a>하는 등 다양한 방식으로 개발을 즐기고 있습니다.
        개발자로서는 조금 특이하게도 수학교육을 전공하였고, 학부 때부터 전공을 살려 여러 사람들을 가르치며 지식을 공유하는 일에 즐거움을 느껴 개발자가 된 이후에도 <strong>오프라인 강의, 오픈소스 문서 번역 등 다양한 방법으로 지식을 나누려 노력</strong>하고 있습니다.
      `,
      contacts: [
      ...
      content: [
        {
          name: '프론트엔드',
          items: [
            '주로 React를 사용하여 앱을 만듭니다. 재사용 로직을 분리하기 위해 커스텀 Hooks을 자유롭게 활용하고, 다양한 최적화 기법과 컴포넌트 디자인 패턴을 사용하는 데 능숙합니다.',
            'ES2015를 포함한 JavaScript 문법에 능숙하며, ECMAScript의 최신 명세와 동향을 꾸준히 살피고 학습합니다.',
            '합성, 커링, 재귀 등 함수형 프로그래밍 기법을 적극적으로 활용합니다.',
            'TypeScript의 기본 개념을 숙지하고 활용할 수 있지만, 아직 자신있게 말할 수 있을 만큼 깊게 알진 못 합니다. 그러나 최근 진행한 프로젝트를 모두 TypeScript로 작성하면서 지속적으로 감을 익히려 노력하고 있습니다.',
        ...
        },
        {
          ...
          items: [
            ...
            '지나친 문서화보다 중요한 내용만을 골라내 문서화시키는 일에 능숙합니다.',
    ...
    educations: {
      ...
      content: [
        {
          name: '패스트캠퍼스 프론트엔드 스쿨 수료',
          period: '(Nov 2017 - Feb 2018)',
          description: '비교적 늦은 나이에 개발을 시작한만큼, 혼자 공부할 때 생기는 삽질의 과정과 시간의 낭비를 최대한 줄이고자 당시에 가장 전문적이라 생각했던 패스트캠퍼스 프론트엔드 스쿨 교육과정을 수강했습니다.',
        },
        {
          name: '동국대학교 수학교육과 졸',
