module.exports = {
  siteMetadata: {
    ...
    about: {
      ...
      content: `
        평범한 3년차 개발자입니다.
        <strong>코드 리뷰 등을 통한 기술적 토론</strong>을 즐기며, 평소에 생각을 글로 정리하고 무엇이든 꼼꼼히 기록하는 습관이 있습니다. 이외에도 개발 커뮤니티 활동에 적극적으로 참여하고 <a href="https://www.notion.so/chayeoi/7450220672254e9398185811949bdfa0?v=7c381efa784840368e31f45e5658cd66" target="_blank">새로운 아이디어가 생각나면 팀을 꾸려 토이 프로젝트를 진행</a>하는 등 다양한 방식으로 개발을 즐기고 있습니다.
