  ...
  siteMetadata: {
    ...
    about: {
      ...
      content: `
        ...
        대학에서는 수학교육을 전공했지만, 내 손으로 세상의 다양한 문제를 능동적으로 해결하고 싶은 마음에 개발자가 되었습니다.
        새로운 기술 학습에도 관심이 많지만, 기술과 문제의 근본을 좀 더 깊이 있게 파보는 걸 더 좋아하는 편입니다.
        사용자에게 좋은 경험을 전달하는 일에 큰 보람을 느끼고, 다양한 분야에서 도전적인 경험을 쌓고 싶습니다.
        또한 교육 분야에 오랫동안 몸을 담가온 덕분에, 개발자가 된 이후에도 여전히 사람들과 지식을 공유하는 일에 즐거움을 느껴 <strong>오프라인 강의, 오픈소스 문서 번역 등 다양한 방법으로 지식을 나누려 노력</strong>하고 있습니다.
      `,
      contacts: [
      ...
      content: [
        {
          ...
          value: 'toss',
          description: `
            <strong>인터넷 전문은행 토스뱅크</strong>에서 프론트엔드 개발자로 일해오면서 토스뱅크 카드, 토스뱅크 홈, 토스뱅크 사전신청, 토스뱅크 목돈굴리기, 머니상담소 등 다양한 서비스를 만들고 있습니다.
          `,
        },
        {
          name: '클래스팅',
